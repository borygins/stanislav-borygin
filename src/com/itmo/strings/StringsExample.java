...
public class StringsExample {
    ...
    public static void formatting() {
        ...
        // В Java 13 добавился метод форматирования для строки  formatted()
        // Он находится в состоянии preview, поэтому пока deprecated,
        // а это значит, что он может быть удален или изменен в будущем.
        String formattedStr = "String with int: %02d, float: %.2f".formatted(1, 1.5F);
    ...
    public static void trimming() {
        ...
        // В Java 11 был добавлен метод strip().
        // Он так же как и trim() убирает пробелы в начале
        // и конце строки, но он лучше работает с Unicode строками.
        String s2 = "  String ".strip();

        System.out.println(s2); // String

        // Можно обрезать пробелы либо в начале, либо в конце строки.
        System.out.println("  String ".stripLeading().equals("String ")); // true
        System.out.println("  String ".stripTrailing().equals("  String")); // true

        String spaced = "  ";
        String empty = spaced.strip();

        System.out.println(spaced.isEmpty()); // false
        System.out.println(empty.isEmpty()); // true

        // Начиная с Java 11 появился метод isBlank(),
        // который проверяет строка пустая или содержит
        // только пробелы.
        System.out.println(spaced.isBlank()); // true
    }
    ...
    public static void multilineString() {
        // В Java 13 появились строки, которые могут содержать
        // несколько строк. Пока на этапе preview.
        ...
        // Вот так приходится делать тоже самое в предыдущих версиях.
        String multilineStringOld = "<html>\n" +
                                    "    <body>\n" +
                                    "        <h1>Hello World!</h1>\n" +
                                    "    </body>\n" +
                                    "</html>";
